...
final class DemoSeeder extends Seeder
{
    ...
    {
        $admin = User::query()->create(['name' => 'Anoteh Administrator', 'email' => 'admin@anoteh.local', 'phone' => '+37120000001', 'password' => 'password', 'role' => UserRole::Admin, 'email_verified_at' => now('UTC')]);
        $manager = User::query()->create(['name' => 'Fleet Manager', 'email' => 'manager@anoteh.local', 'phone' => '+37120000002', 'password' => 'password', 'role' => UserRole::Manager, 'email_verified_at' => now('UTC')]);
